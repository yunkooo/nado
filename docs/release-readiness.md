...
- 마지막 운영 부분 검증: 2026-07-16 09:28 KST ([Notion 티켓](https://app.notion.com/p/39e8944ab9b7814b86b8c2115f65a5ae))
...
| Web      | 학습 흐름 구현                 | 배포 origin, OAuth, 좁은 화면       | [운영 검증](https://app.notion.com/p/39e8944ab9b7814b86b8c2115f65a5ae) | 2026-07-16 09:28 KST |
...
- [x] Vercel Web에서 운영 API 분석과 Google 로그인을 확인한다.
...
- Google 검증 계정으로 로그인한 뒤 GLM 분석에서 `astrolabe`를 저장했다. 단어장 9개와 복습 `1 / 9` 카드에 반영된 것을 확인하고 정답 공개와 다음 카드 이동을 실행했다.
- 검증 항목의 뜻만 삭제한 뒤 단어장과 복습이 모두 8개로 돌아온 것을 확인해 운영 데이터도 정리했다.
...
- [x] 플랫폼 검증 결과를 날짜·환경·실패 지점과 함께 관련 Notion 티켓에 기록한다.

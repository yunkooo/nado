...
5. `@nado/ui-native Card` 최소 구현
   - 완료: `@nado/ui-native`에 `Card`와 `createCardStyle`을 추가한다.
...
7. Mobile `wordDefinitionCard` Native Card 적용
...
10. Mobile `vocabularyType` Native Badge 적용

...
const ANALYSIS_INSTRUCTIONS = [
  ...
  "vocabularyItems에는 원문 속 고유 영어 단어를 각각 한 번만 저장 가능한 후보로 포함하세요. 같은 단어의 반복 항목은 만들지 말고 표현/숙어는 추가 후보로 포함할 수 있습니다.",
  "뜻과 설명은 각각 학습에 필요한 한 문장으로 간결하게 쓰고, structure는 최대 3개, 문장별 grammarPoints는 최대 2개, vocabularySuggestions는 최대 5개로 제한하세요.",
  "추론 과정이나 schema 밖의 설명을 추가하지 말고 요청된 JSON 결과만 완성하세요.",

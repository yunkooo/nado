...
export const analysisMock: AnalysisResultData = {
  ...
  sentences: [
    {
      ...
      tokens: [
        { text: "Many", vocabularyKey: null },
        { text: "developers", vocabularyKey: null },
        { text: "choose", vocabularyKey: null },
        { text: "a", vocabularyKey: null },
        { text: "framework", vocabularyKey: "framework" },
        { text: "because", vocabularyKey: null },
        { text: "it", vocabularyKey: null },
        { text: "promises", vocabularyKey: null },
        { text: "faster", vocabularyKey: null },
        { text: "shipping", vocabularyKey: "shipping" },
        { text: "but", vocabularyKey: null },
        { text: "the", vocabularyKey: null },
        { text: "real", vocabularyKey: null },
        { text: "test", vocabularyKey: null },
        { text: "appears", vocabularyKey: null },
        { text: "after", vocabularyKey: null },
        { text: "the", vocabularyKey: null },
        { text: "product", vocabularyKey: null },
        { text: "grows", vocabularyKey: null },
      ],
      grammarPoints: [
        {
          target: "because",
    ...
    },
    {
      ...
      tokens: [
        { text: "A", vocabularyKey: null },
        { text: "simple", vocabularyKey: null },
        { text: "setup", vocabularyKey: "setup" },
        { text: "can", vocabularyKey: null },
        { text: "help", vocabularyKey: null },
        { text: "a", vocabularyKey: null },
        { text: "small", vocabularyKey: null },
        { text: "team", vocabularyKey: null },
        { text: "move", vocabularyKey: null },
        { text: "quickly", vocabularyKey: null },
        { text: "while", vocabularyKey: null },
        { text: "unclear", vocabularyKey: null },
        { text: "rules", vocabularyKey: null },
        { text: "can", vocabularyKey: null },
        { text: "make", vocabularyKey: null },
        { text: "every", vocabularyKey: null },
        { text: "change", vocabularyKey: null },
        { text: "harder", vocabularyKey: null },
        { text: "to", vocabularyKey: null },
        { text: "review", vocabularyKey: null },
      ],
      grammarPoints: [
        {
    ...
    },
    {
      ...
      naturalTranslation:
        "도구를 추가하기 전에 팀은 자주 반복되는 문제가 무엇인지, 감당 가능한 비용은 어디까지인지, 더 가벼운 절차로 충분한 순간은 언제인지 먼저 이해해야 합니다.",
      tokens: [
        { text: "Before", vocabularyKey: null },
        { text: "adding", vocabularyKey: null },
        { text: "tools", vocabularyKey: null },
        { text: "the", vocabularyKey: null },
        { text: "team", vocabularyKey: null },
        { text: "should", vocabularyKey: null },
        { text: "understand", vocabularyKey: null },
        { text: "which", vocabularyKey: null },
        { text: "problems", vocabularyKey: null },
        { text: "are", vocabularyKey: null },
        { text: "frequent", vocabularyKey: null },
        { text: "which", vocabularyKey: null },
        { text: "costs", vocabularyKey: null },
        { text: "are", vocabularyKey: null },
        { text: "acceptable", vocabularyKey: "acceptable" },
        { text: "and", vocabularyKey: null },
        { text: "when", vocabularyKey: null },
        { text: "a", vocabularyKey: null },
        { text: "lighter", vocabularyKey: "lighter-process" },
        { text: "process", vocabularyKey: "lighter-process" },
        { text: "is", vocabularyKey: null },
        { text: "enough", vocabularyKey: null },
      ],
      grammarPoints: [
        {
    ...
    },
    {
      ...
      naturalTranslation:
        "이런 습관은 회사가 바뀌어도 제품 팀의 속도를 과하게 늦추지 않으면서 코드베이스를 유지보수하기 쉬운 상태로 지켜줍니다.",
      tokens: [
        { text: "This", vocabularyKey: null },
        { text: "habit", vocabularyKey: null },
        { text: "keeps", vocabularyKey: null },
        { text: "the", vocabularyKey: null },
        { text: "codebase", vocabularyKey: null },
        { text: "easier", vocabularyKey: null },
        { text: "to", vocabularyKey: null },
        { text: "maintain", vocabularyKey: "maintain" },
        { text: "without", vocabularyKey: null },
        { text: "slowing", vocabularyKey: null },
        { text: "the", vocabularyKey: null },
        { text: "product", vocabularyKey: null },
        { text: "team", vocabularyKey: null },
        { text: "down", vocabularyKey: null },
        { text: "as", vocabularyKey: null },
        { text: "the", vocabularyKey: null },
        { text: "company", vocabularyKey: null },
        { text: "changes", vocabularyKey: null },
      ],
      grammarPoints: [
        {
  ...
  vocabularyItems: [
    {
      baseForm: "framework",
      contextMeaning: "앱을 만들 때 기반이 되는 개발 도구나 구조를 뜻합니다.",
      key: "framework",
      meaning: "프레임워크",
      partOfSpeech: "명사",
      term: "framework",
    ...
    {
      baseForm: "shipping",
      contextMeaning: "제품을 사용자에게 배포하거나 출시하는 일을 말합니다.",
      key: "shipping",
      meaning: "출시/배포",
      partOfSpeech: "명사",
      term: "shipping",
    ...
    {
      baseForm: "setup",
      contextMeaning: "팀이 일하기 위해 갖춘 구성이나 환경을 뜻합니다.",
      key: "setup",
      meaning: "구성",
      partOfSpeech: "명사",
      term: "setup",
    ...
    {
      baseForm: "acceptable",
      contextMeaning: "팀이 감당할 수 있는 수준의 비용을 말합니다.",
      key: "acceptable",
      meaning: "감수 가능한",
      partOfSpeech: "형용사",
      term: "acceptable",
    ...
    {
      baseForm: "lighter process",
      contextMeaning: "도구와 절차를 과하게 늘리지 않은 간단한 방식입니다.",
      key: "lighter-process",
      meaning: "더 가벼운 절차",
      partOfSpeech: null,
    ...
    {
      baseForm: "maintain",
      contextMeaning: "코드베이스를 계속 관리하기 쉬운 상태로 두는 일입니다.",
      key: "maintain",
      meaning: "유지보수하다",
      partOfSpeech: "동사",
      term: "maintain",
